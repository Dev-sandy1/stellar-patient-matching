...
<svelte:head>
	<title>Stellar Patient Matching</title>
	<meta name="description" content="Stellar-native clinical trial patient matching with zero-knowledge privacy. Your health data never leaves the enclave." />
	<meta property="og:title" content="Stellar Patient Matching" />
	<meta property="og:description" content="Stellar-native clinical trial patient matching with zero-knowledge privacy." />
</svelte:head>
	...
	<main class="pt-20">
		...
		<section class="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-grid-pattern">
			...
			<div class="relative z-10 max-w-[1280px] mx-auto px-margin-mobile md:px-margin-desktop text-center mt-[-10vh]">
				...
				<h1 class="text-display-xl md:text-[72px] font-bold text-on-surface mb-6 leading-tight tracking-tight text-glow max-w-4xl mx-auto">
					Stellar-native.<br />
					<span class="text-primary">100% Patient Privacy.</span>
				</h1>
				
				<p class="text-body-lg text-on-surface-variant max-w-2xl mx-auto mb-10 leading-relaxed">
					Stellar Patient Matching uses Trusted Execution Environments (TEEs) to cross-reference your genomic and clinical data with active trials—without ever exposing your raw data to anyone. Not even us.
				</p>
		...
		<section id="privacy" class="py-24 px-margin-mobile md:px-margin-desktop max-w-[1280px] mx-auto">
			<div class="text-center mb-16">
				...
				<p class="text-body-lg text-on-surface-variant max-w-2xl mx-auto">Traditional matching requires handing over your data. Stellar Patient Matching reverses the paradigm by bringing the algorithm to your encrypted data.</p>
			</div>
